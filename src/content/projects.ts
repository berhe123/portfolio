...
export const projects: ProjectCaseStudy[] = [
  ...
  },
  {
    ...
    name: 'IDEAGO',
    shortDescription:
      'An idea-to-product platform I built as a Freelancer / Self-Employed developer to help business owners and developers turn raw ideas into structured execution plans.',
    overview:
      'As a Freelancer / Self-Employed engineer, I developed IDEAGO end to end as a full stack product that connects founders and engineers around one shared workflow. The platform turns scattered brainstorming into organized product planning with prioritization, roadmaps, and clear next actions — built with React, NestJS, TypeScript, and Node.js.',
    problem:
    ...
    solution:
      'Created structured idea canvases, scoring workflows, and roadmap-oriented planning views so founders and developers can move ideas into executable product plans.',
    architecture:
    ...
    features: [
      ...
      'Responsive full stack product experience for independent product delivery',
    ],
    challenges: [
    ...
    lessons: [
      ...
      'Clear domain boundaries speed up independent product delivery',
    ],
    ...
    githubUrl: 'https://github.com/',
    year: '2026',
    role: 'Freelance / Self-Employed · Full Stack Web Developer',
    accent: '#60a5fa',
    gradient: 'from-sky-500/25 via-blue-600/10 to-[#0a0c10]',
  },
  {
    ...
    tags: ['AI', 'Freelance', 'Full Stack'],
    liveUrl: 'https://brandcast.digital',
    githubUrl: 'https://github.com/berhe123/brandcast',
    year: '2025',
    role: 'Freelance / Self-Employed · Full Stack Developer',
    accent: '#60a5fa',
    gradient: 'from-sky-500/25 via-blue-600/10 to-[#0a0c10]',
  },
]
