...
export const projects: ProjectCaseStudy[] = [
  {
    ...
    technologies: ['JavaScript', 'TypeScript', 'React', 'Next.js', 'Node.js', 'Express.js', 'Docker'],
  ...
  },
  {
    ...
    technologies: ['JavaScript', 'TypeScript', 'React', 'Next.js', 'Node.js', 'Express.js'],
  ...
  },
  {
    ...
    technologies: ['JavaScript', 'TypeScript', 'React', 'Next.js', 'Node.js', 'Tailwind CSS'],
